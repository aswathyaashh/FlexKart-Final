...
namespace E_Commerce.infrastructure.RepositoryLayer.services
{
    public class Customer : ICustomer
    {
        ...
        public ApiResponse<bool> Delete(int customerId)
        {
            ...
            CustomerModel customer = _adminDbContext.Customer.FirstOrDefault(i => i.CustomerId == customerId);
        ...
        public ApiResponse<List<CustomerDTO>> Get()
        {
            ...
            var data = _mapper.Map<List<CustomerModel>, List<CustomerDTO>>(_adminDbContext.Customer.Where(e => e.Status == 0).ToList());
